...
public class Employee {
	/*
	 * codeforcoin.com maintains a database of developers for hire by keeping a data
	 * set of productivity, developers can be ranked and offered at a rate
	 * commensurate with their delivered value, calculated for each job
	 */
	...
	public String toString() {
		return "id " + employeeId + " LOC:" + linesOfCode + " hours:" + hoursBilled + " bugs:" + bugCount + " quality:"
				+ qualityGrade + " quantity:" + quantityRanking + " value:" + valueRanking;
	}
